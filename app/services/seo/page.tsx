...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description:
      "Dominate search rankings with data-driven SEO that doubles organic traffic in 60 days.",
  },
};
...
const faqs = [
  ...
  },
  {
    ...
    a: "Absolutely — in fact, SEO and paid advertising are most powerful when run together as part of an integrated digital marketing strategy. Paid search data provides invaluable insights for SEO: ad campaigns can quickly test which keywords and messages convert best before you invest heavily in organic content. Organic rankings provide a safety net when CPC prices rise, reducing your dependence on paid traffic for profitability. Together, owning both paid and organic positions for your key search terms doubles your visibility, increases brand trust (users see you twice on the same results page), and ultimately drives more qualified traffic than either channel alone. At Firas Digital, our paid media and SEO teams collaborate closely, sharing keyword intelligence, conversion data, and audience insights to make both channels more effective.",
  },
];

const benefits = [
  {
    title: "340% Avg. Traffic Growth",
    desc: "Our clients see dramatic increases in organic search traffic, delivering compounding returns that grow over time without ongoing ad spend.",
  },
  {
    title: "Technical SEO Excellence",
    desc: "We fix the foundational issues — Core Web Vitals, crawlability, site architecture — that silently cost you rankings every day.",
  },
  {
    title: "Content Authority Building",
    desc: "Comprehensive content strategies that establish your brand as the definitive authority in your niche, driving backlinks naturally.",
  },
  {
    title: "Aggressive Link Acquisition",
    desc: "White-hat link building that builds genuine authority through digital PR, guest posting, and resource-based link earning.",
  },
  {
    title: "60-Day Results",
    desc: "We prioritise quick wins — targeting high-opportunity, lower-competition terms first while building long-term authority in parallel.",
  },
  {
    title: "Full Transparency",
    desc: "Monthly reports in plain language, live keyword ranking dashboards, and direct access to your dedicated SEO strategist.",
  },
];
...
const stats = [
  ...
  { value: "Page 1", label: "Rankings Delivered" },
];
  ...
  "@graph": [
    {
      "@type": "Service",
      "name": "SEO Services",
      "description": "Data-driven SEO services including technical SEO, content strategy, and link building that doubles organic traffic in 60 days.",
      "provider": {
        "@type": "Organization",
        "name": "Firas Digital",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative py-24 px-6 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <p className="text-lg md:text-xl text-on-surface-variant max-w-2xl leading-relaxed mb-10">
            Data-driven SEO that combines technical excellence, content authority building, and aggressive link acquisition to double your organic traffic in 60 days.
          </p>
      ...
      <section className="py-20 px-6 bg-surface-container-low">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-on-surface-variant leading-relaxed space-y-4">
            ...
            <p>
              Our SEO methodology is built on three pillars. First, technical excellence: we ensure your website is perfectly structured for search engine crawlers — fast, mobile-friendly, properly indexed, and free of technical errors that silently suppress rankings. Second, content authority: we develop comprehensive content strategies that position your brand as the definitive expert in your niche, covering every topic your target audience searches for across all stages of their buying journey. Third, link acquisition: we build high-quality backlinks from authoritative, relevant domains through ethical, white-hat techniques that build sustainable authority.
            </p>
            <p>
              Whether you are a UAE-based business looking to dominate local search in Dubai or Abu Dhabi, or an international brand targeting global audiences, Firas Digital has the expertise, tools, and track record to deliver SEO results that translate directly into business growth. We serve B2B and B2C clients across e-commerce, professional services, hospitality, real estate, healthcare, and technology sectors.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {benefits.map((b, i) => (
              <div key={i} className="bg-surface-container rounded-2xl p-6 border border-outline-variant/20 flex flex-col gap-3">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-secondary to-green-500 flex items-center justify-center flex-shrink-0">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#0b0e17" strokeWidth="2.2" strokeLinecap="round">
          ...
          <div className="flex flex-col gap-6">
            {process.map((p) => (
              <div key={p.step} className="flex gap-6 items-start bg-surface-container rounded-2xl p-6 border border-outline-variant/20">
                <span className="text-3xl font-black text-secondary flex-shrink-0 w-12">{p.step}</span>
                <div>
      ...
      <section className="py-16 px-6 bg-gradient-to-r from-secondary/5 via-green-900/10 to-background border-y border-outline-variant/10">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          {stats.map((s) => (
            <div key={s.label}>
              <div className="text-4xl md:text-5xl font-black text-secondary mb-2">{s.value}</div>
      ...
      <section className="py-24 px-6 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-on-surface-variant mb-10 text-lg leading-relaxed">
            Book a free SEO audit. We&apos;ll analyse your current organic performance, identify the biggest opportunities, and show you exactly what it will take to dominate your category in search.
          </p>
